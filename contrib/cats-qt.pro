...
RESOURCES += src/qt/cats.qrc src/qt/cats_locale.qrc

TRANSLATIONS += src/qt/locale/cats_bg.ts \
                src/qt/locale/cats_de.ts \
                src/qt/locale/cats_en.ts \
                src/qt/locale/cats_es.ts \
                src/qt/locale/cats_fi.ts \
                src/qt/locale/cats_fr.ts \
                src/qt/locale/cats_it.ts \
                src/qt/locale/cats_ja.ts \
                src/qt/locale/cats_pl.ts \
                src/qt/locale/cats_pt.ts \
                src/qt/locale/cats_ru.ts \
                src/qt/locale/cats_sk.ts \
                src/qt/locale/cats_sv.ts \
                src/qt/locale/cats_vi.ts \
                src/qt/locale/cats_zh_CN.ts \
                src/qt/locale/cats_zh_TW.ts
