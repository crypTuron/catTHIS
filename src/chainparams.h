...
public:
    ...
    int CatsBadBlockTime() const { return nCatsBadBlockTime; }
    int CatsBadBlocknBits() const { return nCatsBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nCatsBadBlockTime;
    unsigned int nCatsBadBlocknBits;
