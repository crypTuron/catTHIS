...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cats features */
        {"cats", "listmasternodes", &listmasternodes, true, true, false},
        {"cats", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cats", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cats", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cats", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cats", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cats", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cats", "masternodedebug", &masternodedebug, true, true, false},
        {"cats", "startmasternode", &startmasternode, true, true, false},
        {"cats", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cats", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cats", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cats", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cats", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cats", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cats", "preparebudget", &preparebudget, true, true, false},
        {"cats", "submitbudget", &submitbudget, true, true, false},
        {"cats", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cats", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cats", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cats", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cats", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cats", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cats", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cats", "checkbudgets", &checkbudgets, true, true, false},
        {"cats", "mnsync", &mnsync, true, true, false},
        {"cats", "spork", &spork, true, true, false},
        {"cats", "getpoolinfo", &getpoolinfo, true, true, false},
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22711/\n";
}
