...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "cats" is a composite category enabling all CATS-related debug output
            if (ptrCategory->count(std::string("cats"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "cats.conf"));
    ...
    if (!streamConfig.good()) {
        ...
        if (configFile != NULL)
		{
            std::string strHeader =
                "# catThis Configuration File!\n"
                "For more information regarding config values readthe config help file."
                "https://github.com/catTHIS-Project/catTHIS/contrib/debian/examples/cats.conf"
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "catsd.pid"));
