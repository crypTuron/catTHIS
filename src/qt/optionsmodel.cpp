...
// Wallet
    ...
    if (settings.contains("nAnonymizeCatsAmount"))
        SoftSetArg("-anonymizecatsamount", settings.value("nAnonymizeCatsAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in cats.cpp during shotdown to also remove the window positions
